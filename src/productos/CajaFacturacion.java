...
public class CajaFacturacion extends javax.swing.JFrame {
    ...
    private void calcularTotales() {
        ...
        for (int i = 0; i < totalFilas; i++) {
            String valorColumnaTotal = modelo.getValueAt(i, 3).toString();
...
// Forma de inicialización 2
    ...
    int cantidad = (int) modelo.getValueAt(filaSeleccionada, 0);
    ...
    if (ventana.getRootPane() != null) {
        modelo.setValueAt(ventana.getCantidad(), filaSeleccionada, 0);
        modelo.setValueAt(ventana.getProducto(), filaSeleccionada, 1);
        modelo.setValueAt(ventana.getPrecio(), filaSeleccionada, 2);
        modelo.setValueAt(ventana.getCantidad() * ventana.getPrecio(), filaSeleccionada, 3);
        calcularTotales();
    }
    ...
    int respuesta = JOptionPane.showConfirmDialog(this, "¿Estás seguro de que deseas eliminar esta fila?", "Confirmar eliminación", JOptionPane.YES_NO_OPTION);
